...
public class LaptopAndNotebookPageSteps {
    ...
    public void iFilledAllMandatoryFieldOfCheckoutPage() {
        new CheckoutPage().enterFirstName("Raja");
        new CheckoutPage().enterLastName("Babu");
        new CheckoutPage().enterEmailId("RajaBabu");
        new CheckoutPage().enterTelephone("07788990011");
        new CheckoutPage().enterAddressLine1("55B Ruskin Close");
        new CheckoutPage().enterCity("Ipswich");
        new CheckoutPage().enterPostCode("Nr98ey");
